...
const LoginPage = () => {
    ...
    return (
        <main className="min-h-screen bg-background relative flex items-center justify-center px-6 overflow-hidden">
            {/* Background Gradients and Ambient Lights similar to Banner */}
            <div className="absolute inset-0 z-0 pointer-events-none">
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#2a1645]/80 via-background to-[#0f0718] z-0"></div>
                
                {/* Glowing orbs */}
                <div className="absolute top-1/4 -left-[10%] w-[40vw] h-[40vw] rounded-full bg-purple-600/20 blur-[120px] animate-pulse"></div>
                <div className="absolute bottom-0 right-[10%] w-[30vw] h-[30vw] rounded-full bg-orange-600/15 blur-[100px]"></div>
            </div>
            ...
            <div className="w-full max-w-md rounded-3xl border border-white/10 bg-[#2a1645]/60 backdrop-blur-xl p-10 shadow-2xl relative z-10 animate-fade-in-up">
                ...
                <div className="flex justify-center">
                    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-orange-400 to-orange-600 text-white shadow-[0_0_20px_rgba(249,115,22,0.4)]">
                ...
                <div className="mt-8 text-center">
                    <h1 className="text-4xl font-black text-white tracking-tight font-khand">Zico</h1>

                    <p className="mt-3 text-white/70 text-lg font-light">
